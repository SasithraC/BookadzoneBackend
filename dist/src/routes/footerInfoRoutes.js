...
const setFooterManagementName = (req, res, next) => {
    req.managementName = 'footer';
    next();
};
router.post('/', setFooterManagementName, fileUpload_1.upload.single('logo'), footerInfoController_1.default.createFooterInfo);
...
router.put('/updatefooterinfo/:id', setFooterManagementName, fileUpload_1.upload.single('logo'), footerInfoController_1.default.updateFooterInfo);
